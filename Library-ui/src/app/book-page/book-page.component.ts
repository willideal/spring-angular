...
export class BookPageComponent implements OnInit {
  ...
  public titleSaveOrUpdate = 'Add New Book Form';
  ...
  ngOnInit() {
    // load book's categories when loading this component.
    this.loadCategories();
  }
   ...
   * @param addBookForm parametre d'entree
   */
  ...
  setLocalDateToDatePicker(book: Book) {
    const localDate = new Date(book.releaseDate);
   ...
   * @param searchBookForm parametre d'entree
   */
